...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WFPDocument.date_updated'
        db.add_column(u'wfpdocs_wfpdocument', 'date_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2014, 5, 9), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WFPDocument.date_updated'
        db.delete_column(u'wfpdocs_wfpdocument', 'date_updated')
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 9, 11, 24, 55, 73215)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 9, 11, 24, 55, 77879)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 9, 11, 24, 55, 77413)'}),
