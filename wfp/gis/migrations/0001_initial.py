...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Office'
        db.create_table(u'gis_office', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('wfpid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('place', self.gf('django.db.models.fields.CharField')(max_length=254)),
            ('facility', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('iso3', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('iso3_op', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('locprecisi', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('wfpregion', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('nat_staff', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('int_staff', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('lastcheckd', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('updatedate', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('objectidol', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('precisiono', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('verifiedol', self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True)),
            ('geometry', self.gf('django.contrib.gis.db.models.fields.PointField')()),
        ))
        db.send_create_signal(u'gis', ['Office'])

        # Adding model 'Employee'
        db.create_table(u'gis_employee', (
            ('gis_level', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('duties_type', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['people.Profile'], unique=True, primary_key=True)),
            ('office', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gis.Office'], null=True, blank=True)),
        ))
        db.send_create_signal(u'gis', ['Employee'])


    def backwards(self, orm):
        # Deleting model 'Office'
        db.delete_table(u'gis_office')

        # Deleting model 'Employee'
        db.delete_table(u'gis_employee')
